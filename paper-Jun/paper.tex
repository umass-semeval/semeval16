...
Sentiment analysis on these data, which determines the attitude of a user with respect to some topic or product, will provide convincing information. For example, it may help manufacturing companies to know how people like their product (or service), what would people prefer.
Therefore sentiment analysis on microblogging has obtained special interest. 
